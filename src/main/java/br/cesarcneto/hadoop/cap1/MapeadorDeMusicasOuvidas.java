...
public class MapeadorDeMusicasOuvidas extends Mapper<NullWritable, Text, Text, LongWritable> {
	...
	@Override
	protected void map(final NullWritable key, final Text registroDeLog, final Mapper<NullWritable, Text, Text, LongWritable>.Context contexto) throws IOException, InterruptedException {
